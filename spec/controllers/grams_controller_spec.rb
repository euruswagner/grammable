...
RSpec.describe GramsController, type: :controller do
  describe "grams#destroy action" do
    it "sholdn't allow users who didn't create the gram to destroy it" do
    ...
    it "should return a 404 message if we cannot find a gram with an id that is specified" do
      user = FactoryBot.create(:user)
      sign_in user
  ...
  describe "grams#update action" do
    it "shouldn't let suers who didn't create the gram update it" do
      gram = FactoryBot.create(:gram)
      user = FactoryBot.create(:user)
      sign_in user
  ...
  describe "grams#show action" do
    it "should successfully sho the page if the gram is found" do
      gram = FactoryBot.create(:gram)
